...
let herschelKrustofski: Dictionary<String, Any> = [
    ...
    height: 45,
    soccerExperience: true,
    guardians: "Kyman and Rachel Krustofski"
]
...
// Divvy experienced players between teams
...
// Similarly divvy inexperienced players between teams
// Divvy them in backwards order to mitigate the possibility of uneven number of players
